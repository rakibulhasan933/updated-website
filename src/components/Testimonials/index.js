  ...
  return (
    <div className="container">
        ...
        <Card data-aos="zoom-in" className="myCard">
          <div className="flexRow align-center">
            ...
            <div className="mlr-10">
              <p className="primaryColor font-16">Rakibul Hasan</p>
      ...
      <Card className="m-auto contactCard">
        ...
        <a href="http://www.rakibulmd933@gmail.com" target="_blank" rel="noopener noreferrer" className="text-center font-25">rakibulmd933@gmail.com</a>
      </Card>
    </div>
  );
};
